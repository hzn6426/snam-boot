...
$dockerbin run -di --restart=always --network=host -v /usr/local/snam/authority/logs:/logs/snam-authority --name snam-authority"${md}" -p 8091:8091 snam/authority:v"${md}"
