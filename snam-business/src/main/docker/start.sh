...
$dockerbin run -di --restart=always --network=host --memory=2g --memory-swap=2g  -v /usr/local/snam/business/logs:/deployments/logs/snam-business --name snam-business"${md}" -p 8092:8092 snam/business:v"${md}"
